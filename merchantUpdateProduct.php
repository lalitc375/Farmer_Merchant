...
<b> Location</b>
 ...
 {
 	echo "<tr><td>".($i+1)."</td><td>".$result[$i]->get("Product")."</td><td>".$result[$i]->get("cost")."</td><td>".$result[$i]->get("max_amount")."</td><td>".$result[$i]->get("Location")."</td><td>"."<a href='http://localhost/Pragyan_Hack/merchantProductUpdateData.php?id=".$result[$i]->getObjectId()."'>Update</a></td></tr>";
 }
