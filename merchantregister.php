...
<a class="btn btn-info" href="merchant.php" role="button">Back</a>
</div>
</div>
<div class="col-sm-12">
<br>
<center><h3>Merchant's Registration Page</h3></center>
</div>



<br><br><br><br><br><br><br><br>
<form class="form-horizontal col-sm-5 col-sm-offset-3" action="merchantdata.php" method="post">
 ...
 <div class="form-group">
    ...
    <div class="col-sm-8">
      <input type="email" class="form-control" name="email" id="inputemail" placeholder="Email-ID" required>
    </div>
  </div>
 <div class="form-group">
 ...
 <div class="form-group">
    <label for="inputpreferlocation" class="col-sm-3 control-label">Prefer Location</label>
    <div class="col-sm-8">
      <input type="text" class="form-control" name="location" id="inputlocation" placeholder="Prfer Location" required>
    </div>
  </div> 
  <div class="form-group">
